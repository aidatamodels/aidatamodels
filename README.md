...
### Langages, outils et plateformes
...
### Développement web et visualisation interactive
...
- la génération d’un fichier `dashboard_data.json` avec Python ;
- la visualisation cartographique avec Leaflet.js ;
...
🔗 [Voir le dépôt GitHub](https://github.com/aidatamodels/quebec-city-permit-intelligence-dashboard)

🌐 [Ouvrir le dashboard](https://aidatamodels.github.io/quebec-city-permit-intelligence-dashboard/)
